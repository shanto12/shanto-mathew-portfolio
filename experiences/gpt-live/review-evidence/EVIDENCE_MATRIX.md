...
Final admission availability and settled accounting are recorded in `budget-final.jsonl` and `health-final.json`. The owner-review allowance must be available before delivery.
