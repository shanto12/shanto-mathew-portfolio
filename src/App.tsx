...
function Hero() {
  return <section className="hero section-shell" id="home"><div className="hero-copy"><div className="hero-kicker"><StatusPill>OPEN TO THE RIGHT PROBLEM</StatusPill><span className="mono">AI × SECURITY × PRODUCT</span></div><p className="eyebrow">Forward-deployed AI engineer</p><h1>I make complex systems<br /><span>feel inevitable.</span></h1><p className="hero-summary">I&apos;m Shanto Mathew — a senior AI security automation engineer who turns messy operational workflows into governed, useful, beautifully shipped software.</p><div className="hero-profile"><div className="hero-profile-frame"><img className="hero-profile-photo" src="/shanto-mathew-headshot.jpeg" alt="Shanto Mathew smiling in a suit" /><span className="hero-profile-badge"><span className="status-pulse" /> profile online</span></div><div className="hero-profile-copy"><span className="mono">SHANTO MATHEW / FDE</span><strong>Human context + machine speed.</strong><span>Dallas–Fort Worth · remote-friendly</span></div></div><div className="hero-actions"><a className="button button--primary" href="#work">Explore the work <ArrowDownRight size={17} /></a><a className="button button--ghost" href="#contact">Start a conversation <Mail size={17} /></a></div><div className="hero-proof-row"><span><MapPin size={15} /> Dallas–Fort Worth · remote-friendly</span><span><CheckCircle2 size={15} /> public-safe by design</span></div></div><HeroWorkbench /></section>
}
